...
embedded systems.  It is a collection of git
...
To test out the release branch type:
    ...
    $ repo init -u git://github.com/hiiaka/yocto-manifests.git -b rocko
    $ repo sync
...
To test out the bleeding edge, type:
    ...
    $ repo init -u git://github.com/gumstix/yocto-manifest.git -b sumo
    $ repo sync
