...
embedded systems.  It is a collection of git repositories known as *layers* 
each of which provides *recipes* to build software packages 
...
To use the release branch, type:
    ...
    $ repo init -u git://github.com/hiiaka/yocto-manifest.git -b master
...
Clone this repository (or fork it on github):
    ...
    $ git clone git://github.com/hiiaka/yocto-manifest.git
